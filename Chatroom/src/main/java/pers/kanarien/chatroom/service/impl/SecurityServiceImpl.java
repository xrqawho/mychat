...
public class SecurityServiceImpl implements SecurityService{
    ...
    @Override
    public ResponseJson login(String username, String password, HttpSession session, HttpServletRequest request) {
    ...
    public void addUserCilent(User userInfo) {
        userInfoDao.addUserCilent(userInfo);
    }

    @Override
    public void removeFriend(User user) {
        userInfoDao.removeFriend(user);
    }
